      ...
      setTimeout(() => {
          try {
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            ...
                            <div class="product-details-content">
                                ...
                                <div class="description" style="padding:15px 0;">
                                    ...
                                    <div class="pro-details-quality mt-0px" style="margin-bottom:15px;">
                                        <!--<div class="cart-plus-minus">
                                            ...
                                            <input type="hidden" name="proid" value="1/assets/css/assets/js/vendor/assets/images/logo/assets/css/assets/js" />
                                        </div>-->
										...
										<!--<div class="pro_details_buy_now_btn btn-hover">
                                            <a href="https://getwayrom.com/checkout.php?proid=1/assets/css/assets/js/vendor/assets/images/logo/assets/css/assets/js&qty=1" class="buy_now_btn"> Buy Now</a>
                                        </div>-->
                                        
										<!--<div class="pro-details-wish-com" style="border:none;">
											<div class="pro-details-whatsapp" style="border:none;">
												<a href="https://api.whatsapp.com/send?phone=918511400395&text=*I%20want%20to%20Buy*%20test%20https://www.buyprimal.in/product.php?id=1/assets/css/assets/js/vendor/assets/images/logo/assets/css/assets/js" target="_blank" style="font-size:40px; color:green; border:none;"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
											</div>
											<div class="pro-details-wishlist">
												<a href="wishlist.php?proid=1/assets/css/assets/js/vendor/assets/images/logo/assets/css/assets/js&qty=1"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
											</div>									
										</div>-->
                                ...
                                <!--<div class="pro-details-wish-com">
                                    <div class="pro-details-wishlist">
                                        <a href="wishlist.php?proid=1/assets/css/assets/js/vendor/assets/images/logo/assets/css/assets/js&qty=1"><i class="ion-android-favorite-outline"></i>Add to wishlist</a>
                                    </div>
								...
								<div style="padding-bottom:15px;"><b><h4 style="font-size:14px; font-weight:bold;">ALSO AVAILABLE AT</h4></b></div>
								    ...
								    <a href="https://api.whatsapp.com/send?phone=919420630774&text=*I%20want%20to%20Buy*%20test%20https://www.getwayrom.com/product.php?id=1/assets/css/assets/js/vendor/assets/images/logo/assets/css/assets/js" class="whatsapp_link" target="_blank">
                                    ...
                                    <div class="social-info">
                                        <ul>
                                            <li><a href="https://www.facebook.com/sharer.php?u=http://getwayrom.com/product.php?id=1/assets/css/assets/js/vendor/assets/images/logo/assets/css/assets/js" target="_blank"><i class="ion-social-facebook"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://twitter.com/intent/tweet?text=test&url=http://getwayrom.com/product.php?id=1/assets/css/assets/js/vendor/assets/images/logo/assets/css/assets/js" target="_blank"><i class="ion-social-twitter"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://plus.google.com/share?url=http://getwayrom.com/product.php?id=1/assets/css/assets/js/vendor/assets/images/logo/assets/css/assets/js" target="_blank"><i class="ion-social-google"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://www.instagram.com/?url=http://getwayrom.com/product.php?id=1/assets/css/assets/js/vendor/assets/images/logo/assets/css/assets/js" target="_blank"><i class="ion-social-instagram"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://api.whatsapp.com/send?phone=919420630774&text=Interested%20to%20Buy%20https://www.getwayrom.com/product.php?id=1/assets/css/assets/js/vendor/assets/images/logo/assets/css/assets/js" target="_blank"><i class="ion-social-whatsapp"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <p>&nbsp;</p><p>&nbsp;</p>
                	...
                	<ul>
                		<li><a href="https://getwayrom.com/cart.php?proid=1/assets/css/assets/js/vendor/assets/images/logo/assets/css/assets/js&qty=1" class="add_cart_btn">Add To Cart</a></li>
                		<li><a href="https://getwayrom.com/checkout.php?proid=1/assets/css/assets/js/vendor/assets/images/logo/assets/css/assets/js&qty=1" class="buy_now_btn">Buy Now</a></li>
                	</ul>
                </div>
